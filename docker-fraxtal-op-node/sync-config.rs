...
const CONFIG_BASE_URL: &str =
    "https://raw.githubusercontent.com/FraxFinance/fraxtal-node/refs/heads/master/mainnet";

#[derive(Parser, Debug)]
#[command(name = "sync-config")]
#[command(about = "Sync configuration files for fraxtal-op-node", long_about = None)]
