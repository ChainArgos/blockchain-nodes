...
docker run -v $HOME/heimdall:/heimdall-home:rw --entrypoint /usr/bin/heimdalld -it 0xpolygon/heimdall-v2:0.6.0 init chainargos --home=/heimdall-home --chain-id heimdallv2-137
